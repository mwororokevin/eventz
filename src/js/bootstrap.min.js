    ...
    var r,
        ...
        Mn = (p = "button", y = "." + (v = "bs.button"), E = ".data-api", C = (m = e).fn[p], T = "active", b = "btn", I = '[data-toggle^="button"]', A = '[data-toggle="buttons"]', D = "input", w = ".active", N = ".btn", O = {
            ...
            return t.toggle = function () {
                ...
                e && this
                    ._element
                    .setAttribute("aria-pressed", !this._element.classList.contains(T)),
        ...
        Qn = (j = "carousel", L = "." + (H = "bs.carousel"), R = ".data-api", x = (P = e).fn[j], W = {
            ...
            t.pause = function (t) {
                ...
                this
                    ._element
                    .querySelector(et) && (Fn.triggerTransitionEnd(this._element), this.cycle(!0)),
            ...
            t._getItemIndex = function (t) {
                return this._items = t && t.parentNode
                    ? []
                        .slice
                        .call(t.parentNode.querySelectorAll(tt))
                    : [],
                this
                    ._items
                    .indexOf(t)
            ...
            t._setActiveIndicatorElement = function (t) {
                if (this._indicatorsElement) {
                    var e = []
                        .slice
                        .call(this._indicatorsElement.querySelectorAll($));
                    P(e).removeClass(V);
        ...
        Bn = (at = "collapse", ct = "." + (lt = "bs.collapse"), ht = (st = e).fn[at], ut = {
            ...
            t.show = function () {
                ...
                if (!this._isTransitioning && !st(this._element).hasClass(gt) && (this._parent && 0 === (t = [].slice.call(this._parent.querySelectorAll(Et)).filter(function (t) {
                    ...
                    if (st(this._element).trigger(i), !i.isDefaultPrevented()) {
                        ...
                        this._triggerArray.length && st(this._triggerArray)
                            .removeClass(pt)
            ...
            a._jQueryInterface = function (i) {
                return this.each(function () {
                    var t = st(this),
                        e = t.data(lt),
                        n = l({}, ut, t.data(), "object" == typeof i && i
                            ? i
                            : {});
        ...
        Vn = (St = "dropdown", At = "." + (It = "bs.dropdown"), Dt = ".data-api", wt = (bt = e).fn[St], Nt = new RegExp("38|40|27"), Ot = {
                ...
                if (!this._element.disabled && !bt(this._element).hasClass(kt)) {
                    ...
                    if (c._clearMenus(), !e) {
                        ...
                        if (bt(t).trigger(i), !i.isDefaultPrevented()) {
                            ...
                            "ontouchstart" in document.documentElement && 0 === bt(t)
                                .closest(Ft)
                                .length && bt(document.body)
                                .children()
            ...
            c._jQueryInterface = function (e) {
                return this.each(function () {
                    ...
                    if (t || (t = new c(this, "object" == typeof e
                        ? e
        ...
        Yn = (Xt = "modal", ee = "." + (te = "bs.modal"), ne = ($t = e).fn[Xt], ie = {
            ...
            t.show = function (t) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    this._isShown || n.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), $t(document.body).addClass(le), this._setEscapeEvent(), this._setResizeEvent(), $t(this._element).on(oe.CLICK_DISMISS, de, function (t) {
                        ...
                        $t(e._element)
                            .one(oe.MOUSEUP_DISMISS, function (t) {
                ...
                if (this._isShown && this._config.backdrop) {
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = ae, n && this._backdrop.classList.add(n), $t(this._backdrop).appendTo(document.body), $t(this._element).on(oe.CLICK_DISMISS, function (t) {
                        e._ignoreBackdropClick
                            ...
                            : t.target === t.currentTarget && ("static" === e._config.backdrop
                                ? e._element.focus()
                                : e.hide())
            ...
            t._setScrollbar = function () {
                ...
                if (this._isBodyOverflowing) {
                    var t = []
                            .slice
                            .call(document.querySelectorAll(ge)),
                        e = []
                            .slice
                            .call(document.querySelectorAll(_e));
            ...
            r._jQueryInterface = function (n, i) {
                return this.each(function () {
                    var t = $t(this).data(te),
                        e = l({}, ie, $t(this).data(), "object" == typeof n && n
                            ? n
                            : {});
        ...
        zn = (ve = "tooltip", Ee = "." + (ye = "bs.tooltip"), Ce = (pe = e).fn[ve], Te = "bs-tooltip", be = new RegExp("(^|\\s)" + Te + "\\S+", "g"), Ae = {
            ...
            t.show = function () {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    pe(i).addClass(ke),
                    "ontouchstart" in document.documentElement && pe(document.body)
                        .children()
            ...
            t.hide = function (t) {
                var e = this,
                    ...
                    r = function () {
                        e._hoverState !== De && n.parentNode && n
                            .parentNode
                            .removeChild(n),
                        e._cleanTipClass(),
                        e
            ...
            t._enter = function (t, e) {
                ...
                t && (e._activeTrigger["focusin" === t.type
                        ? Le
                        : He] = !0),
            ...
            t._leave = function (t, e) {
                var n = this.constructor.DATA_KEY;
                (e = e || pe(t.currentTarget).data(n)) || (e = new this.constructor(t.currentTarget, this._getDelegateConfig()), pe(t.currentTarget).data(n, e)),
                t && (e._activeTrigger["focusout" === t.type
                        ? Le
                        : He] = !1),
                e._isWithActiveTrigger() || (clearTimeout(e._timeout), e._hoverState = we, e.config.delay && e.config.delay.hide
                    ? e._timeout = setTimeout(function () {
            ...
            t._getConfig = function (t) {
                return "number" == typeof(t = l({}, this.constructor.Default, pe(this.element).data(), "object" == typeof t && t
                    ? t
                    : {})).delay && (t.delay = {
                    show: t.delay,
                    hide: t.delay
        ...
        Zn = (en = "scrollspy", rn = "." + (nn = "bs.scrollspy"), on = (tn = e).fn[en], sn = {
            ...
            t._getConfig = function (t) {
                if ("string" != typeof(t = l({}, sn, "object" == typeof t && t
                    ? t
                    : {})).target) {
